...
export default async function Feed({
  ...
  return (
    <div className="h-full max-w-2xl sm:min-w-[672px] min-w-[320px] mx-auto bg-sline-alpha-dark-050 rounded-t-3xl overflow-hidden relative z-10 border border-border border-b-0">
